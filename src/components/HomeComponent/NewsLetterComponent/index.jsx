...
export default function NewsLetterComponent(){
    return (
        <section className="w-full flex gap-[51px] h-[440px] bg-[#D2D8E1] py-[77px] px-[135px] ">
        <div style={{
            backgroundImage: 'url(../images/news-bg-2.png)',
        ...
        <div className="w-[623px] ">
            ...
            <input type="text" placeholder="Your email" className="border-b-[2px] border-b-[#fff] w-[276px] mb-[22px] bg-transparent pb-[10px] outline-0 text-[#fff] text-[16px] " />
