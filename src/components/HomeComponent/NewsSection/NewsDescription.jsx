...
export default function NewsDescription({section, title, abstract}){
    ...
    return (
        <div className="w-[600px] mb-[60px] ">
            ...
            <h2 className="text-[24px] text-[#171A22] font-[400] font-Chonburi mb-[26px] ">{title}</h2>

            <p className="text-[18px] font-[400] text-[#5A6372] mb-[11px] ">{abstract}</p>
